...
describe('Icon', () => {
  ...
  it('adds class same as passed down as props', () => {
    ...
    const svgIconWrapper = screen.getByTestId('svg-icon-wrapper');
  ...
  it('adds height and width same as passed down as props', () => {
    ...
    const svgIconWrapper = screen.getByTestId('svg-icon-wrapper');
    expect(svgIconWrapper).toHaveStyle('height: 50px');
    expect(svgIconWrapper).toHaveStyle('width: 50px');
  });
  ...
  it('renders the proper icon as passed down as props', () => {
    ...
    const svgIconPath = screen.getByTestId('svg-icon-path');
  ...
  it('adds the extraClasses if passed down as props', () => {
    render(
      <Icon
        icon={HomeIcon}
        height="50"
    ...
    const svgIconWrapper = screen.getByTestId('svg-icon-wrapper');
    expect(svgIconWrapper).toHaveClass('hover:text-slate-500 cursor-pointer');
  });
});
